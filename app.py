...
PESTICIDE_RECOMMENDATIONS: dict[str, str] = {
    "Early Blight": "Spray Mancozeb 75% WP @ 2.5g/L or Chlorothalonil 75% WP @ 2g/L.",
    "Late Blight": "Spray Metalaxyl 8% + Mancozeb 64% WP @ 2g/L or Copper Oxychloride 50% WP @ 3g/L.",
    "Leaf Spot": "Apply Copper fungicide or Neem oil extract (5ml/L) with systemic spray.",
    ...
    "Healthy": "Crop is healthy! Maintain regular inspection, balanced NPK fertilizing, and clean cultivation.",
}
